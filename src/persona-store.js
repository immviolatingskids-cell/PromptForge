...
export class PersonaStore{
  ...
  browserData(){return {personas:this.all(),personaLibrary:structuredClone(this.metadata()),versionMetadata:{application:"1.0.0",project:1,scene:1,projection:1,contextPackage:1}};}
