...
export function normalizeProject(raw = {}) {
  ...
  return {
    ...
    context: normalizeProjectContext(project.context), defaults: normalizeProjectDefaults(project.defaults), personaRefs, memberState,
    ...
    entities: { casts: Array.isArray(project.entities?.casts) ? structuredClone(project.entities.casts) : [], groups: Array.isArray(project.entities?.groups) ? structuredClone(project.entities.groups) : [], relationships: Array.isArray(project.entities?.relationships) ? structuredClone(project.entities.relationships) : (Array.isArray(project.relationships) ? structuredClone(project.relationships) : []), locations: Array.isArray(project.entities?.locations) ? structuredClone(project.entities.locations) : [], scenes: Array.isArray(project.entities?.scenes) ? structuredClone(project.entities.scenes) : [] },
