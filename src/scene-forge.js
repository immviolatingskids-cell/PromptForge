...
import { resolveMultiPersonProjection } from "./multi-person-projection.js";
...
export function resolveSceneForge({ scene, personas = [], projects = [], locations = [], casts = [], groups = [], relationships = [], library = {} }) {
  ...
  const projection = resolveMultiPersonProjection({ scene, personas, project, cast, group, relationships: relationshipEvidence, location, settings: scene.projection || {} });
